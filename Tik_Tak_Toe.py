...
GREEN = (28, 170, 156)
CIRCLE_COLOR = (145, 0, 0)
X_COLOR = (130, 145, 200)
BG_COLOR = (255, 145, 145)
CIRCLE_RADIUS = 50
CIRCLE_WIDTH = 10
X_WIDTH = 25
SPACE = 55
    ...
    for row in range(BOARD_ROWS):
        for col in range(BOARD_COLS):
            if board[row][col] == 1:
                ...
                pygame.draw.line(screen, X_COLOR, (col * 200 + SPACE, row * 200 +
                                                   200 - SPACE), (col * 200 + 200 - SPACE, row * 200 + SPACE), X_WIDTH)
                pygame.draw.line(screen, X_COLOR, (col * 200 + SPACE, row * 200 +
                                                   SPACE), (col * 200 + 200 - SPACE, row * 200 + 200 - SPACE), X_WIDTH)
